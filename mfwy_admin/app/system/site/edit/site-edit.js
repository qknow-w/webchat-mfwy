 ...
 */
angular.module("site-edit", ["resource.sites"]).config([
    "$routeProvider", function ($routeProvider) {
        return $routeProvider.when("/system/site/new", {
            templateUrl: "/app/system/site/edit/site-edit.tpl.html",
            controller: 'SiteEditCtrl',
            resolve: {
                site: function () {
                    return ac = {
                        name: "",//����
                        AddressInfo:{province:"",city:"",district:""}
                    };
                }
            }
        }).when("/system/site/:id", {
            ...
            resolve: {
                site: [
                    "$q", "$route", "Sites", function ($q, $route, Sites) {
                        var deferred;
                        deferred = $q.defer();
                        Sites.get({
    ...
    .controller("SiteEditCtrl", ["$scope", "$routeParams", "$location", "$rootScope","$http", "Sites", "site", "messager",'Cards','ipCookie',
        function ($scope, $routeParams, $location, $rootScope,$http,Sites, site, messager,Cards,ipCookie) {
            $scope.get = function () {
